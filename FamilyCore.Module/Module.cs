...
namespace FamilyCore.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class FamilyCoreModule : ModuleBase {
    public FamilyCoreModule() {
		// 
		// FamilyCoreModule
		// 
		AdditionalExportedTypes.Add(typeof(FamilyCore.Module.BusinessObjects.ApplicationUser));
